...
public class GuestNewActivity extends ActionBarActivity implements CourseItemAllAdapter.ClickListener{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_guest_new, menu);
        return true;
    }
